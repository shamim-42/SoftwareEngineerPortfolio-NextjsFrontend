      ...
      >
        <div className="align-between flex flex-col justify-between gap-2 ">
          <div className="mt-4 flex space-x-6 sm:mt-0 sm:justify-center">
            <Link
              href={basicData?.facebook || socialsData.facebook}
            ...
            <Link
              href={basicData?.linkedin || socialsData.linkedIn}
            ...
            <Link
              href={basicData?.twitter || socialsData.twitter}
            ...
            <Link
              href={basicData?.github || socialsData.github}
            ...
            <Link
              href={basicData?.stackoverflow || socialsData.stackOverflow}
          ...
          <p className="text-sm">
            Mail: {basicData?.mail || socialsData?.mail}
          </p>
        </div>
